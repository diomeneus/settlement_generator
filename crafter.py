...
class Controls_Enchanter(Frame):
    def __init__(self, parent, controller):
        Frame.__init__(self, parent)
        self.controller = controller
...
class Main(Tk):
    def __init__(self):
        ...
        #assuming the choice of launcher will be "gear generator" for now
        launcher = "GearGen"
        ...
        self.frames = {}
        for F in (Controls_GearGen, Controls_Enchanter, Controls_Crafter):
    ...
    def key_commit(self, event=None): #writes the layout string lists to the database
        ...
        with self.conn:
            ...
            print("**************************"+self.layouttype+" Layout committed to database*********************************")
